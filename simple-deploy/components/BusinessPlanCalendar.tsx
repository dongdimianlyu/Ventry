...
export default function BusinessPlanCalendar({ plan, businessType }: PlanCalendarProps) {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-6 p-6">
              ...
              return (
                <motion.div
                  ...
                  className={`
                    ...
                    ${isToday(date) ? 'bg-indigo-100 ring-1 ring-indigo-500' : ''}
                    ${isSelected(date) ? 'bg-indigo-50 ring-2 ring-indigo-400' : 'hover:bg-gray-50'}
                ...
                >
                  <div className="flex justify-between items-center">
                    <span className={`text-xs font-medium 
                      ...
                      ${isSelected(date) ? 'text-indigo-800' : ''}
                    `}>
                      {date.getDate()}
                    </span>
      ...
      <div className="lg:w-2/5">
        <div className="bg-gray-50 rounded-xl shadow-sm border border-gray-200 h-full">
          <div className="p-6 border-b border-gray-200">
            <div className="flex items-center">
              <div className="mr-4">
                <div className={`
                  w-12 h-12 rounded-lg flex items-center justify-center
                  ${isToday(selectedDate) ? 'bg-indigo-600' : 'bg-gray-200'}
          ...
          {selectedDateTasks.length > 0 ? (
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="mt-2 flex items-center">
                        <span className="text-xs text-gray-500">Week {task.week}, Day {task.day}</span>
                        <span className={`
            ...
            <div className="p-6 flex flex-col items-center justify-center h-64 text-center">
              ...
              <h3 className="text-lg font-medium text-gray-700 mb-1">No Tasks for This Day</h3>
