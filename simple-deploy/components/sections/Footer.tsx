  ...
  return (
    <footer className="mt-12 relative z-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 py-8">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-gray-400 text-sm mb-4">
              AI-powered business planning for the modern entrepreneur
            </p>
            <div className="space-x-4">
              ...
              <a href="https://github.com" className="text-gray-400 hover:text-gray-300" aria-label="GitHub">
                <svg className="h-5 w-5 inline-block" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div key={idx}>
              ...
              <ul className="space-y-3">
                {group.links.map((link, linkIdx) => (
                  <li key={linkIdx}>
                    <Link href={link.href} className="text-gray-400 hover:text-gray-300 text-sm">
                      {link.name}
                    </Link>
                  </li>
                ))}
        ...
        {/* Beta tagline */}
        <div className="py-4 border-t border-gray-800 mb-4">
          <div className="inline-flex items-center px-2.5 py-0.5 rounded-md text-sm font-medium bg-indigo-900/30 text-indigo-300 border border-indigo-700/30">
        ...
        {/* Copyright */}
        <div className="py-6 border-t border-gray-800 md:flex md:items-center md:justify-between">
          <div className="text-sm text-gray-400">
            &copy; {currentYear} Ventry, Inc. All rights reserved.
          </div>
